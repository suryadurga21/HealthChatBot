...
def getDiseaseInfo(keywords):
    try:
        # Perform a search query using DuckDuckGo's search URL
        search_url = f"https://duckduckgo.com/html/?q={keywords}"
        ...
        if response.status_code == 200:
            ...
            body = response.text
            # You might need to parse the HTML to extract the relevant content
            # Here, we are returning the raw HTML content for demonstration purposes
            return body
        else:
